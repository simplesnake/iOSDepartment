...
//        */
//        let container = NSPersistentContainer(name: "Mobilization")
...
//        print("DEBUG / PUSH NOTIFICATIONS / Firebase registration token: \(fcmToken ?? "no token")")
//        if let token = fcmToken {
//            StorageManager.sharedInstance.pushToken = token
//        }
//    }
//
//
